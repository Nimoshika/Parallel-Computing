...
void HyperCube_Class::HyperCube_QuickSort() {
	...
	if (nbr_k > my_id) {
	    // MPI-2: Send number of elements less than or equal pivot
	    ...
	    // MPI-5: Receive neighbor's list of elements that are greater than or equal to pivot
	    ...
	    // MPI-8: Receive neighbor's list of elements that are lesser than or equal to the pivot
