...
int main(int argc, char *argv[]) {
    ...
    // Read input, validate
    if (argc != 4) {
    printf("Need three integers as input \n");
    printf("Use: <executable_name> <log_2(matrix_size)> <log_2(leaf_matrix_size)> <num_threads>\n");
    exit(0);
    }
    k = atoi(argv[argc-3]);
    matrix_size = (1 << k);
    ...
    printf("num_threads exceeds max_threads ...\n");
    };
